...
class DetallePlato extends Component{
    ...
    getPlatoXIdServer(){
        ...
        fetch('http://localhost:8081/WebAppServer/RestoServlet?action=buscar&idPlato='+parametroId)
    ...
    render(){
        ...
        const imageurl = "http://localhost:8081/WebAppServer/images/" + platoEncontrado.imagenPath;
