<%-- 
    Document   : NoticiaAlta
    Created on : 21 mar. 2020, 21:35:50
    Author     : franc
--%>
...
<html>
    ...
    <body>
        <%
            ServletEmpresa servletEmpresa = new ServletEmpresa();
            Empresa empresa = servletEmpresa.traeUnaEmpresa(Integer.parseInt(request.getParameter("idEmpresa")));
        %>
        <h1>Cargue sus noticias</h1>
        <form id="formNoticia" action="http://localhost:8080/TrabajoPractico1/ServletNoticia" onsubmit="return enviarDatos();">
            <table>
                <tr>
                    <td>T&iacute;tulo</td>
            ...
            <button type="submit" name="accion" value="A">Alta</button>
        </form>
    </body>
</html>
